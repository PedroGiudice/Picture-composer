Overview
This model is the result of a DARE TIES merge of allenai/tulu-2-dpo-70b, the popular lizpreciatior/lzlv_70b_fp16_hf, and dreamgen/opus-v0.5-70b. I then merged in three LoRAs into the resultant blend:

A 50-50 linear merge of jondurbin/airoboros-l2-70b-2.2.1-peft with dfurman/Llama-2-70B-Instruct-v0.1-peft
...
Quantizations
GGUF -- LoneStriker/Midnight-Rose-70B-v1.0-GGUF and Artefact2/Midnight-Rose-70B-v1.0-GGUF
Exl2 -- LoneStriker has several Exllamav2 quants available. Quick search
